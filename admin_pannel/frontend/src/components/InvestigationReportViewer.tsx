  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://10.191.242.40:5001/api/incidents?limit=100`
      );
        ...
        try {
          ...
          await new Promise((resolve, reject) => {
            ...
            img.onerror = () => {
              ...
              doc.text(
                `[Map unavailable - Location: ${latitude}, ${longitude}]`,
                margin,
                yPos
              );
              yPos += 10;
    ...
    // Download
    doc.save(
      `Investigation_Report_${touristId}_${
      ...
      <div className="report-header">
        <div>
          ...
          <p className="report-meta">
            Case: {report.tourist_id} / {report.trip_id} | Type:{" "}
            {report.incident_type} | Generated:{" "}
